...
export default function ProductDetailsScreen() {
  ...
  // SOLUTION 1: Debug version to see what's happening
// SOLUTION 1: Perfect synchronization - everything matches
const handleAddToCart = () => {
  ...
  //   // Temporary success state - SYNCED WITH TOAST
  //   setJustAdded(true);
  //   setTimeout(() => setJustAdded(false), 2500); // Match toast duration

  //   // Toast feedback - FIXED DURATION
  //   toast.show({
  //     placement: "bottom",
  //     duration: 10000, // Changed from 10000 to 2500 (2.5 seconds)
  //     render: ({ id }) => (
  //       <CustomToast 
  //         id={id} 
